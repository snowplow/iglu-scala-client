...
class RawValidationSpec extends Specification with DataTables {
  ...
  def e2 = {
    ...
    val nonStringExpected = ClientError.ValidatorError.InvalidData(
      NonEmptyList.of(
        ValidatorReport(
          ...
          List("integer", "string"),
          Some("type"))))
    val missingKeyExpected = ClientError.ValidatorError.InvalidData(
      NonEmptyList.of(
        ValidatorReport(
          ...
          List("beers"),
          Some("required"))))
    val heterogeneusArrayExpected = ClientError.ValidatorError.InvalidData(
      NonEmptyList.of(
        ValidatorReport(
          ...
          List("boolean", "string"),
          Some("type"))))
    val doubleErrorExpected = ClientError.ValidatorError.InvalidData(
      NonEmptyList.of(
        ValidatorReport(
          "$.country: integer found, string expected",
          Some("$.country"),
  ...
  def e3 = {
    ...
    val expected = ClientError.ValidatorError.InvalidData(
      NonEmptyList.of(
        ValidatorReport(
